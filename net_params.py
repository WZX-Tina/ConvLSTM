...
convlstm_encoder_params = [
    ...
    [
        CLSTM_cell(shape=(160,240), input_channels=16, filter_size=5, num_features=64),
        CLSTM_cell(shape=(80,120), input_channels=96, filter_size=5, num_features=96),
        CLSTM_cell(shape=(40,60), input_channels=96, filter_size=5, num_features=96)
    ]
]
...
convlstm_decoder_params = [
    ...
    [
        CLSTM_cell(shape=(40,60), input_channels=96, filter_size=5, num_features=96),
        CLSTM_cell(shape=(80,120), input_channels=96, filter_size=5, num_features=96),
        CLSTM_cell(shape=(160,240), input_channels=96, filter_size=5, num_features=64),
    ]
]
...
convgru_decoder_params = [
    ...
    [
        CGRU_cell(shape=(40,60), input_channels=96, filter_size=5, num_features=96),
        CGRU_cell(shape=(80,120), input_channels=96, filter_size=5, num_features=96),
        CGRU_cell(shape=(160,240), input_channels=96, filter_size=5, num_features=64),
    ]
]
